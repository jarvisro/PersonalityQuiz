...
class QuestionViewController: UIViewController {
    ...
    //    Multiple-answer user interface
...
//        Reset positions of sliders
    ...
    //Keep track of questions your app has already displayed and calculate when you've displayed them pg.420
    
    var questionIndex = 0
    
    //Retrieve Answers with Actions pg. 426
